...
Данная программа создана с использованием искусственного интеллекта. Код может содержать ошибки, некорректную логику проверок или другие дефекты.

**Перед использованием на producción серверах обязательно:**

- Проверьте код самостоятельно
- Протестируйте на тестовых серверах
- Убедитесь в корректности проверок для вашей инфраструктуры
